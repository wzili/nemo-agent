...
export default function PermissionsSettingsPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      <PanelHeader title={t('permissions.permissions')} actions={<HeaderMenu route={routes.view.settings('permissions')} helpFeature="permissions" />} />
            ...
            <div className="space-y-8">
              {isLoading ? (
                ...
                <>
                  ...
                  <SettingsSection
                    title={t('permissions.defaultPermissions')}
                    description={t('permissions.noPermissions')}
                    action={
                    ...
                    <SettingsCard className="p-0">
                      {defaultPermissionsData.length > 0 ? (
                        <PermissionsDataTable
                          ...
                          maxHeight={350}
                          fullscreen
                          fullscreenTitle={t('permissions.defaultPermissions')}
                        />
                      ) : (
                        <div className="p-8 text-center text-muted-foreground">
                          <p className="text-sm">{t('permissions.noPermissions')}</p>
                        </div>
                      )}
                    </SettingsCard>
                  </SettingsSection>
                  ...
                  <SettingsSection
                    title={t('permissions.workspaceOverrides')}
                    description={t('permissions.defaultPermissions')}
                    action={
                      (() => {
                    ...
                    <SettingsCard className="p-0">
                      {customPermissionsData.length > 0 ? (
                        <PermissionsDataTable
                          ...
                          maxHeight={350}
                          fullscreen
                          fullscreenTitle={t('permissions.workspaceOverrides')}
                        />
                      ) : (
                        <div className="p-8 text-center text-muted-foreground">
                          <p className="text-sm">{t('permissions.noPermissions')}</p>
