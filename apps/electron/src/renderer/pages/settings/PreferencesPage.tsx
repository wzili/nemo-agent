...
export default function PreferencesPage() {
  ...
  return (
    <div className="h-full flex flex-col">
      <PanelHeader title={t('settings.preferences')} actions={<HeaderMenu route={routes.view.settings('preferences')} helpFeature="preferences" />} />
      <div className="flex-1 min-h-0 mask-fade-y">
        <ScrollArea className="h-full">
          ...
          <SettingsSection
            ...
            description={t('placeholders.yourName')}
          >
            <SettingsCard divided>
              <SettingsInput
                label={t('placeholders.yourName')}
                description={t('placeholders.yourName')}
              ...
              <SettingsInput
                ...
                description={t('placeholders.timezone')}
          ...
          >
            <SettingsCard divided>
              <SettingsInput
                ...
                placeholder={t('workspace.workspaceSettings')}
                inCard
              />
              <SettingsInput
                label={t('workspace.workspaceSettings')}
          ...
          <SettingsSection
            title={t('settings.preferences')}
            description={t('placeholders.describeChange')}
            action={
          ...
          >
            <SettingsCard divided={false}>
              <SettingsTextarea
                ...
                placeholder={t('placeholders.describeChange')}
                rows={5}
                inCard
              />
            </SettingsCard>
