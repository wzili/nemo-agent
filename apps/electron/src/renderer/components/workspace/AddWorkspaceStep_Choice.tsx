  ...
  return (
    <AddWorkspaceContainer>
      ...
      <AddWorkspaceStepHeader
        ...
        description={t('workspace.addWorkspaceDescription')}
      />

      <div className="mt-8 w-full space-y-3">
        <ChoiceCard
          icon={<FolderPlus className="h-5 w-5" />}
          title={t('workspace.createNewOption')}
          description={t('workspace.createNewOptionDescription')}
          onClick={onCreateNew}
          variant="primary"
        />
        ...
        <ChoiceCard
          ...
          description={t('workspace.openFolderDescription')}
